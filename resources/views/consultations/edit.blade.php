    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<form role="form" action="/consultations/{{$consultation->id}}" method="post">
			<div style="padding-bottom:30px;">
				...
				<input class="form-control" name="patient_id" value="{{$consultation->patient_id}}" placeholder="PATIENT_ID" readonly required><br>
				<label style="padding-left:10px;"> PaiementID</label>
				<input class="form-control" name="paiement_id" value="{{$consultation->paiement_id}}" placeholder="PAIEMENT_ID" readonly required><br>
