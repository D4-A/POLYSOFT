    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb" style="height:50px;padding-top:15px;">
				...
				<li class="active">Type Payement</li>
			</ol>
		</div><!--/.row-->

		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Type Payement</h1>
			</div>
		</div><!--/.row--><br>
			...
			<div class="col-lg-2 text-left" style="padding:0;">
				...
				<a href="{{url('/typePayements/create')}}">
					<button type="submit" class="btn btn-success">
						<span class="glyphicon glyphicon-plus" style="padding-right:8px;"></span>Nouveau Type_Payement
					</button>
				</a>
				@endcan
			</div>
		...
		<table class="table table-striped" id="table" style="width:700px;">
			...
			<tr>
			    ...
			    <th scope="col">Nom TypePayement</th>
