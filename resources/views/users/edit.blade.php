		...
		<form role="form" action="/users/{{$user->id}}" method="post">
			<div style="padding-bottom:30px;">
				...
				<div class="form-group">
					...
					<input class="form-control" name="name" value="{{$user->name}}" placeholder="Nom de l'utilisateur"><br>
					<label style="padding-left:10px;">Prénom</label>
					<input class="form-control" name="name" value="{{$user->prenom}}" placeholder="Prénom de l'utilisateur"><br>
					<label style="padding-left:10px;">Service</label>
					<select name="service_id" id="service_id" class="form-control">
						<option placeholder="" value="{{$service->id}}">{{$service->name}}</option>
					...
					<input class="form-control" name="tel" value="{{$user->tel}}" placeholder="Téléphone de l'utilisateur"><br>
					<label style="padding-left:10px;">E-mail</label>
					<input class="form-control" name="email" value="{{$user->email}}" placeholder="Email de l'utilisateur"><br>
					<label style="padding-left:10px;">Carte d'Identité</label>
					<input class="form-control" name="cni" value="{{$user->cni}}" placeholder="Carte_ID de l'utilisateur"><br>
				</div>
